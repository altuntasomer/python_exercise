...
change_language_text_lan = ["Dil Değiştir (F9)","Change Language (F9)"]
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 845, 591))
        ...
        self.pushButton_language = QtWidgets.QPushButton(self.verticalLayoutWidget)
        font = QtGui.QFont()
        ...
        self.pushButton_attach = QtWidgets.QPushButton(self.verticalLayoutWidget)
        font = QtGui.QFont()
    ...
    def send(self):
        ...
        try:
            ...
            if global_attach == True:
                ...
                attachment = open(filename.name, 'rb')

                part = MIMEBase('application', 'octet-stream')
                part.set_payload((attachment).read())
                encoders.encode_base64(part)
                part.add_header('Content-Disposition', "attachment; filename= " + filename.name)
                msg.attach(part)
